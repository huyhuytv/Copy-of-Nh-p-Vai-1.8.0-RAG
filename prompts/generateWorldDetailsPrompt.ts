...
[GENERATED_STORY_TONE: text="${currentStoryTone}"]`;
    ...
    nsfwGuidanceForWorldGen = "- **Yêu cầu nội dung 18+:** TẮT. Vui lòng tạo các yếu tố phù hợp với mọi lứa tuổi, tập trung vào phiêu lưu và phát triển nhân vật. Tránh các chủ đề nhạy cảm, bạo lực quá mức hoặc tình dục khi tạo các yếu tố này.";
  }
...
1.  **Thông Tin Nhân Vật:**
    ...
    *   Tạo Chủng Tộc Nhân Vật (ví dụ: Nhân Tộc, Yêu Tộc, Ma Tộc): [GENERATED_PLAYER_RACE: text="Tên Chủng Tộc Được Tạo"]
    ...
    *   ${isCultivationEnabled ? `Tạo Thọ Nguyên cho nhân vật. Áp dụng **HƯỚN DẪN VỀ THỌ NGUYÊN** đã cung cấp. Ví dụ: [GENERATED_PLAYER_THO_NGUYEN: value=202] [GENERATED_PLAYER_MAX_THO_NGUYEN: value=220]` : ''}

2.  **Thiết Lập Thế Giới:**
    *   Tạo Chủ Đề Thế Giới: [GENERATED_WORLD_THEME: text="Chủ đề thế giới được tạo..."]
    *   Tạo Bối Cảnh Chi Tiết:
        *   Mô tả chi tiết về thế giới, lịch sử, các thế lực chính, và không khí chung.
        *   **Định dạng:** [GENERATED_WORLD_SETTING_DESCRIPTION: text="Bối cảnh chi tiết,..."]
    ...
    *   Tạo Số Tiền Khởi Đầu: [GENERATED_STARTING_CURRENCY: value=X] (Với X là một số tiền hợp lý cho người mới bắt đầu)
    *   **Tạo Ngày Bắt Đầu:** Dựa vào lịch sử và bối cảnh thế giới bạn tạo, hãy chọn một ngày, tháng, năm khởi đầu hợp lý (ví dụ: năm 1024 của Kỷ Nguyên Lửa). [GENERATED_STARTING_DATE: day=15, month=3, year=1024]
...
3.  **Yếu Tố Khởi Đầu Khác (Đảm bảo cung cấp đầy đủ các tham số được yêu cầu cho mỗi tag):**
    ...
    *   Tạo ra 9 đến 10 Vật Phẩm Khởi Đầu thú vị, phù hợp với bối cảnh. **LƯU Ý: KHÔNG tạo ra vật phẩm tiền tệ (như Linh Thạch, Vàng) ở đây.**
        **HƯỚN DẪN CHI TIẾT CHO TAG \`[GENERATED_ITEM: ...]\`:**
        ...
        - **VÍ DỤ (Trang bị):** \`[GENERATED_ITEM: name="Hỏa Vân Kiếm", description="Thanh kiếm được rèn trong địa hỏa, ẩn chứa sức mạnh của lửa.", quantity=1, category="${GameTemplates.ItemCategory.EQUIPMENT}", rarity="${GameTemplates.ItemRarity.QUY_BAU}", itemRealm="Trúc Cơ", equipmentType="${GameTemplates.EquipmentType.VU_KHI}", statBonusesJSON='{"sucTanCong": 50}', uniqueEffectsList="Sát thương gây hiệu ứng bỏng 10 dmg/s trong 3 giây"]\`
        - **VÍ DỤ (Đan dược):** \`[GENERATED_ITEM: name="Hồi Nguyên Đan", description="Đan dược giúp phục hồi linh lực nhanh chóng.", quantity=5, category="${GameTemplates.ItemCategory.POTION}", rarity="${GameTemplates.ItemRarity.HIEM}", itemRealm="Luyện Khí", potionType="${GameTemplates.PotionType.HOI_PHUC}", effectsList="Hồi phục 200 linh lực"]\`
    ...
    *   Tạo ra 9 đến 10 Địa Điểm Khởi Đầu **chính** phù hợp. **Địa điểm đầu tiên trong danh sách sẽ được coi là vị trí khởi đầu của người chơi.** Hãy đảm bảo địa điểm này có tên phù hợp (ví dụ: 'Làng Tân Thủ', 'Căn nhà gỗ', 'Điểm Xuất Phát').
        **Định dạng:** [GENERATED_LOCATION: name="Tên (BẮT BUỘC)", description="Mô tả (BẮT BUỘC)", locationType="CHỌN MỘT TRONG: ${Object.values(GameTemplates.LocationType).join(' | ')}" (BẮT BUỘC), isSafeZone=false (true/false), regionId="Tên Vùng", mapX=100 (BẮT BUỘC, 0-1000), mapY=100 (BẮT BUỘC, 0-1000)]
        ...
        **Ví dụ:** [GENERATED_LOCATION: name="Làng Cổ Thụ", description="Một ngôi làng yên bình nằm sâu trong rừng.", locationType="${GameTemplates.LocationType.VILLAGE}", isSafeZone=true, mapX=250, mapY=300]
