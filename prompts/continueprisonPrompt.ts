...
import { KnowledgeBase, PlayerActionInputType, ResponseLength, GameMessage, DIALOGUE_MARKER, Master } from '../types';
...
**HƯỚN DẪN CƠ CHẾ CHỦ NHÂN & THÂN PHẬN (CỰC KỲ QUAN TRỌNG):**
...
**HƯỚN DẪN TỪ NGƯỜI CHƠI (CHO LƯỢT TIẾP THEO - LƯỢT ${playerStats.turn + 1}):**
...
${prisonContinuePromptSystemRules(worldConfig, statusType, mainRealms)}
`;
};
