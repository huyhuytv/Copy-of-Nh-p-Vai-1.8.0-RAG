...
// Import Utilities
import { parseAndHighlightText } from '../utils/textHighlighting';
...
const GameplayScreen: React.FC = () => {
    ...
    const { isReaderMode, setIsReaderMode, isCharPanelOpen, setIsCharPanelOpen, isQuestsPanelOpen, setIsQuestsPanelOpen, isWorldPanelOpen, setIsWorldPanelOpen, showDebugPanel, setShowDebugPanel } = useGameplayPanels();
    ...
    const {
        ...
        selectedResponseLength, setSelectedResponseLength, isActionTypeDropdownOpen, setIsActionTypeDropdownOpen,
        isResponseLengthDropdownOpen, setIsResponseLengthDropdownOpen, showAiSuggestions, setShowAiSuggestions,
        actionTypeDropdownRef, responseLengthDropdownRef, handleChoiceClick, handleSubmit
    } = usePlayerInput({
    ...
    const isLocationSafe = !!currentLocation?.isSafeZone;
    const isPlayerRestricted = !!game.knowledgeBase.playerStats.playerSpecialStatus;
        ...
        <div className="h-screen flex flex-col bg-gray-900 text-gray-100 p-2 sm:p-4">
             {!isReaderMode && (
                <GameHeader
                    ...
                    setIsStyleSettingsModalOpen={game.setIsStyleSettingsModalOpen}
            ...
            <div className="flex-grow flex flex-col bg-gray-850 shadow-xl rounded-lg overflow-hidden relative min-h-0">
                <StoryLog 
                    ...
                    parseAndHighlightText={(text) => parseAndHighlightText(text, game.knowledgeBase, game.styleSettings, handleKeywordClick)}
                        ...
                        {game.knowledgeBase.pendingCombat ? (
                            ...
                            <>
                                <PlayerInputArea 
                                    ...
                                    isActionTypeDropdownOpen={isActionTypeDropdownOpen} setIsActionTypeDropdownOpen={setIsActionTypeDropdownOpen}
                                ...
                                <PaginationControls
                                    ...
                                    isSummarizing={isSummarizingUi || game.isUploadingAvatar}
                                />
                            </>
                        )}
                    </div>
