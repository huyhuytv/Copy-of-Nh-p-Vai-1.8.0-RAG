  ...
  return (
    ...
    >
      {groupedMessages.map((item, index) => {
        ...
        const msg = item;
        const messageBaseClass = 'max-w-full p-2 sm:p-3 rounded-xl shadow text-sm sm:text-base relative';
      ...
      {(isLoadingUi && !isSummarizingUi && isCurrentlyActivePage && displayedMessages.length > 0) && <div className="text-center text-gray-400 italic py-2 mt-2 text-xs sm:text-sm">{VIETNAMESE.contactingAI}</div>}
