...
const StatDisplay: React.FC<{label: string, value: React.ReactNode, valueClassName?: string}> = ({label, value, valueClassName}) => (
    <div>
...
const StatBar: React.FC<{label: string, value: number, max?: number, colorClass?: string}> = ({label, value, max = 100, colorClass = 'bg-teal-500'}) => (
...
const MasterPanel: React.FC<MasterPanelProps> = ({ master }) => {
